...
async def start_message(c,m):
    ...
    await m.reply_photo(f"https://te.legra.ph/file/119729ea3cdce4fefb6a1.jpg",
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                InlineKeyboardButton('💝 join main ᴄʜᴀɴɴᴇʟ', url=' https://t.me/danger_chart_group')
            ],[
                InlineKeyboardButton("❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ", url='https://t.me/Danger998'),
                InlineKeyboardButton("🤖 ᴜᴘᴅᴀᴛᴇ", url=' https://t.me/danger_chart_group')
            ]]
        )
    )
